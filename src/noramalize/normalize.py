...
def normalize_books(books_path: str) -> Tuple[DataFrame, DataFrame, DataFrame]:
    """
    ...
    return book_table, authors_table, book_authors_table
...
def main():
    ...
    try:
        book_table, authors_table, book_authors_table = normalize_books(books_path)
    except Exception as e:
